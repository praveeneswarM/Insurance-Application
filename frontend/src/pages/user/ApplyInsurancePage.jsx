...
const pdfOcrStatuses = ['PENDING', 'PROCESSING', 'COMPLETED', 'FAILED'];
            ...
            <div className="mt-4 space-y-3">
              ...
              {uploadedDocs.map((doc) => (
                <div key={doc.blobName} className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  {pdfOcrStatuses.includes(doc.ocrStatus) && <p className="mt-2 text-sm text-white/60">OCR Status: {doc.ocrStatus}</p>}
